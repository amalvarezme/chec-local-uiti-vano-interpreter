...
# Los radares de `chec_impacto.interpretability.circuit_analysis` llaman a
# `plt.show()`, que bloquea sobre un backend interactivo (el de macOS, por
# ejemplo) sin pantalla conectada -- una corrida headless no puede quedarse
# esperando una ventana que nunca se va a mostrar.
import matplotlib
