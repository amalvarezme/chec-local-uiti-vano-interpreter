...
2. **Grafo estimado por muestra o escenario:** entregable interpretativo generado en `notebooks/project_flow/05_mgcecdl_circuit_analysis.ipynb`. Se estima a partir de la capa de reconstrucción del modelo MGCECDL y una similitud RBF entre perfiles reconstruidos de variables. Se exporta como HTML interactivo en `reports/mgcecdl-results/interactive_graphs/`.
