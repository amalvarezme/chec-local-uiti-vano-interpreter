...
- No incluyas bloques `<think>`, razonamiento interno, markdown ni texto fuera del JSON.
- Analiza los valores de las variables, los modos y las reglas fisico-logicas dentro del contenido final del JSON, sin exponer razonamiento paso a paso.
