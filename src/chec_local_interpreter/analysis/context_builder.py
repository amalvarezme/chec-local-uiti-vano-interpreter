...
from chec_local_interpreter.data.loader import resolve_columns
from chec_local_interpreter.analysis.domain_context import domain_context_payload
...
def build_context_package(
    *,
    ...
    try:
        from chec_local_interpreter.analysis.graph_extractor import build_graphify_context
...
def _compute_circuit_characterization(
    ...
    *,
    ...
    try:
        from chec_local_interpreter.reports.plotting import run_kmeans
