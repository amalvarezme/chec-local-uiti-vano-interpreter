...
def render_llm_analysis(
    ...
    def _mapas_ventana_html() -> str:
        ...
        nota = (
            ...
            "<li>Se eligen por tres preguntas distintas: la <b>última</b> es cómo está "
            "hoy el circuito; la de <b>mayor UITI acumulado</b> es el momento que más "
            "dolió; y la de <b>más vanos tocados</b> es el momento más extendido, que "
            "rara vez es el mismo — una ventana puede concentrar todo su UITI en dos "
            "vanos y otra repartir menos entre veinte.</li>"
            "<li>Los criterios se aplican <b>en ese orden y sobre las que van "
            "quedando</b>: la última entra siempre, y las otras dos se buscan entre las "
            "que todavía no entraron. Por eso una ventana rotulada por un criterio no "
            "siempre es el máximo de la tabla — si lo es, la columna «¿Por qué se "
            "estudió?» lo dice sin salvedades; si no, dice «entre las ventanas "
            "restantes».</li>"
