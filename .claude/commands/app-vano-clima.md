...
>
> Este comando publica el cuaderno `01_uiti_vano_clima.ipynb` parcheando su CODIGO por contenido:
...
>
> Ese codigo **ya no esta en el cuaderno**: vive en `src/chec_tableros/clima.py`
