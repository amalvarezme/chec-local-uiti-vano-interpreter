#!/bin/sh
# NO ES EL DESTINO DEL DOBLE CLIC. Ver la nota de `abrir-en-terminal.command`, al lado:
# con Ghostty atado a los `.command`, el doble clic sobre este archivo no ejecuta nada.
#
# Crea el entorno de esta aplicacion e instala sus dependencias. Se corre UNA vez, a mano
# desde una terminal ya abierta -- y es el camino de Linux, donde no hay bundle:
#
