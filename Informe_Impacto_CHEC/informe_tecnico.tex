...
\begin{table}[H]
\centering
\caption{Resultado del protocolo de validación con criterio de aceptación prerregistrado}
...
Criterio de aceptación prerregistrado & $+5{,}0$ puntos \\
...
El protocolo de validación del modelo no alcanzó el criterio de aceptación prerregistrado. El
análisis del
