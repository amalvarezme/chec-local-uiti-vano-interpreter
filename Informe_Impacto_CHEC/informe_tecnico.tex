...
traslado de datos es despreciable: $0{,}80$~ms de transferencia y $0{,}23$~ms de armado del lote,
frente a un paso completo de 172~ms. Y una red equivalente en tamaño, entrenada sobre lotes del
mismo número de instancias, corre \emph{más rápido} en la GPU integrada que en la CPU
($0{,}90$~ms contra $1{,}21$~ms), de modo que el tamaño del modelo tampoco es el factor.
...
\midrule
El mismo lote repetido (forma fija)      & $9{,}99$~ms & $15{,}12$~ms & $1{,}5\times$ \\
Lotes distintos (forma variable, el caso real) & $9{,}03$~ms & $106{,}27$~ms & $11{,}8\times$ \\
\bottomrule
\end{tabularx}
\end{table}

Siete de esas once veces provienen únicamente de la recompilación por cambio de forma. La
memoria confirma el mecanismo: con forma fija el controlador reserva $62{,}9$~MB y con forma
variable $129{,}6$~MB, mientras los tensores efectivamente vivos son los mismos en ambos casos
---alrededor de 24~MB---. El exceso es caché de núcleos compilados, no datos.
...
\begin{itemize}
  ...
  \item \textbf{La interacción es mitigable, pero no cambia la decisión.} Rellenar los lotes
        hasta un número fijo de instancias recuperaría ese factor de siete. Aun así la GPU
        integrada quedaría un $50$\,\% por encima de la CPU, de modo que la conclusión
