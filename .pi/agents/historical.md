# Historical Agent Role (Pi mirror)

Same role as the Claude Code agent at `.claude/agents/historical.md`.
Read that file plus `.claude/skills/historical/SKILL.md` for the full persona,
