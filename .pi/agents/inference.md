# Inference Agent Role (Pi mirror)

Same role as the Claude Code agent at `.claude/agents/inference.md`.
Read that file plus `.claude/skills/inference/SKILL.md` for the full persona,
